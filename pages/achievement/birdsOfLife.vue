...
function OpenPopupPanel() {
    projectLayout.value.OpenPopupPanel();
}
</script>
        ...
        <ProjectLayout ref="projectLayout">
            ...
            <template #info>
                ...
                <PartItem2 img="" @open="OpenPopupPanel()">
                    ...
                    <template
                        #word>{{$t('pages.home.child.achievement.child.birdsOfLife.author.content[0].infoShort')}}</template>
                </PartItem2>

                <PartItemNull>
                    <template #title>{{$t('pages.home.child.achievement.child.birdsOfLife.works.title')}}</template>
                    <div class="flex flex-wrap justify-between">
                        <Item @open="OpenPopupPanel()">{{$t('pages.home.child.achievement.child.birdsOfLife.works.content[0].name')}}</Item>
                        <Item @open="OpenPopupPanel()">{{$t('pages.home.child.achievement.child.birdsOfLife.works.content[1].name')}}</Item>
                        <Item @open="OpenPopupPanel()">{{$t('pages.home.child.achievement.child.birdsOfLife.works.content[2].name')}}</Item>
                        <Item @open="OpenPopupPanel()">{{$t('pages.home.child.achievement.child.birdsOfLife.works.content[3].name')}}</Item>
                        <Item @open="OpenPopupPanel()">{{$t('pages.home.child.achievement.child.birdsOfLife.works.content[4].name')}}</Item>
                        <Item @open="OpenPopupPanel()">{{$t('pages.home.child.achievement.child.birdsOfLife.works.content[5].name')}}</Item>
                    </div>
                </PartItemNull>
